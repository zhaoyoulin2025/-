<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="${comment}" prop="followUpTime">
    ...
    <el-table v-loading="loading" :data="followupList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="${comment}" align="center" prop="followUpTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.followUpTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="${comment}" align="center" prop="followUpDescription" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="${comment}" prop="followUpDescription">
          <el-input v-model="form.followUpDescription" type="textarea" placeholder="请输入内容" />
        </el-form-item>
      </el-form>
...
<script>
import { listFollowup, getFollowup, delFollowup, addFollowup, updateFollowup } from "@/api/system/followup"
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/followup/export', {
        ...this.queryParams
