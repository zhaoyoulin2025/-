<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="文件类型" prop="fileItem">
        <el-input
          v-model="queryParams.fileItem"
          placeholder="请输入文件类型"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="关联项目ID" prop="itemId">
        <el-input
      ...
      <el-form-item label="上传时间" prop="sTime">
    ...
    <el-table v-loading="loading" :data="fileList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="文件类型" align="center" prop="fileItem" />
      <el-table-column label="关联项目ID" align="center" prop="itemId" />
      <el-table-column label="是否使用" align="center" prop="isUse" />
      <el-table-column label="文件描述" align="center" prop="desc" />
      <el-table-column label="文件链接" align="center" prop="url" />
      <el-table-column label="上传时间" align="center" prop="sTime" width="180">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="文件类型" prop="fileItem">
          <el-input v-model="form.fileItem" placeholder="请输入文件类型" />
        </el-form-item>
        <el-form-item label="关联项目ID" prop="itemId">
          <el-input v-model="form.itemId" placeholder="请输入关联项目ID" />
        </el-form-item>
        <el-form-item label="是否使用" prop="isUse">
        ...
        <el-form-item label="文件链接" prop="url">
          <el-input v-model="form.url" placeholder="请输入文件链接" />
        </el-form-item>
        <el-form-item label="上传时间" prop="sTime">
          <el-date-picker clearable
            v-model="form.sTime"
